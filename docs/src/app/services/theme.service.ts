...
export class ThemeService {
  ...
  readonly themes: ThemeInfo[] = [
    ...
    { id: 'cerulean-dark', name: 'Cerulean Dark', description: 'Dark mode of the calm blue sky theme', isDark: true, category: 'Bootswatch' },
    { id: 'cosmo', name: 'Cosmo', description: 'An ode to Metro with vibrant blue', isDark: false, category: 'Bootswatch' },
    { id: 'cosmo-dark', name: 'Cosmo Dark', description: 'Dark mode of Metro-inspired theme', isDark: true, category: 'Bootswatch' },
    { id: 'cyborg', name: 'Cyborg', description: 'Jet black with electric cyan accents', isDark: true, category: 'Bootswatch' },
    { id: 'cyborg-light', name: 'Cyborg Light', description: 'Light mode with electric cyan accents', isDark: false, category: 'Bootswatch' },
    ...
    { id: 'journal-dark', name: 'Journal Dark', description: 'Dark mode of the crisp journal theme', isDark: true, category: 'Bootswatch' },
    { id: 'litera', name: 'Litera', description: 'The medium is the message', isDark: false, category: 'Bootswatch' },
    { id: 'litera-dark', name: 'Litera Dark', description: 'Dark mode of the literary theme', isDark: true, category: 'Bootswatch' },
    { id: 'lumen', name: 'Lumen', description: 'Light and shadow', isDark: false, category: 'Bootswatch' },
    { id: 'lumen-dark', name: 'Lumen Dark', description: 'Dark mode with dramatic shadows', isDark: true, category: 'Bootswatch' },
    { id: 'lux', name: 'Lux', description: 'A touch of class', isDark: false, category: 'Bootswatch' },
    { id: 'lux-dark', name: 'Lux Dark', description: 'Dark mode with elegant gold accents', isDark: true, category: 'Bootswatch' },
    { id: 'materia', name: 'Materia', description: 'Material design inspired', isDark: false, category: 'Bootswatch' },
    { id: 'materia-dark', name: 'Materia Dark', description: 'Dark Material Design theme', isDark: true, category: 'Bootswatch' },
    { id: 'minty', name: 'Minty', description: 'A fresh feel', isDark: false, category: 'Bootswatch' },
    { id: 'minty-dark', name: 'Minty Dark', description: 'Dark mode with fresh mint accents', isDark: true, category: 'Bootswatch' },
    { id: 'morph', name: 'Morph', description: 'Soft neumorphism', isDark: false, category: 'Bootswatch' },
    { id: 'morph-dark', name: 'Morph Dark', description: 'Dark neumorphism aesthetic', isDark: true, category: 'Bootswatch' },
    { id: 'pulse', name: 'Pulse', description: 'A trace of purple', isDark: false, category: 'Bootswatch' },
    { id: 'pulse-dark', name: 'Pulse Dark', description: 'Dark mode with purple accents', isDark: true, category: 'Bootswatch' },
    { id: 'quartz', name: 'Quartz', description: 'Glassmorphism aesthetic', isDark: true, category: 'Bootswatch' },
    { id: 'quartz-light', name: 'Quartz Light', description: 'Light glassmorphism aesthetic', isDark: false, category: 'Bootswatch' },
    { id: 'sandstone', name: 'Sandstone', description: 'A touch of warmth', isDark: false, category: 'Bootswatch' },
    { id: 'sandstone-dark', name: 'Sandstone Dark', description: 'Dark mode with warm sandstone tones', isDark: true, category: 'Bootswatch' },
    { id: 'simplex', name: 'Simplex', description: 'Mini and minimalist', isDark: false, category: 'Bootswatch' },
    { id: 'simplex-dark', name: 'Simplex Dark', description: 'Dark minimalist theme', isDark: true, category: 'Bootswatch' },
    { id: 'sketchy', name: 'Sketchy', description: 'A hand-drawn look', isDark: false, category: 'Bootswatch' },
    { id: 'sketchy-dark', name: 'Sketchy Dark', description: 'Dark hand-drawn aesthetic', isDark: true, category: 'Bootswatch' },
    { id: 'slate', name: 'Slate', description: 'Shades of gunmetal gray', isDark: true, category: 'Bootswatch' },
    { id: 'slate-light', name: 'Slate Light', description: 'Light mode with gunmetal accents', isDark: false, category: 'Bootswatch' },
    { id: 'solar', name: 'Solar', description: 'A spin on Solarized', isDark: true, category: 'Bootswatch' },
    { id: 'solar-light', name: 'Solar Light', description: 'Light Solarized color scheme', isDark: false, category: 'Bootswatch' },
    { id: 'spacelab', name: 'Spacelab', description: 'Silvery and sleek', isDark: false, category: 'Bootswatch' },
    { id: 'spacelab-dark', name: 'Spacelab Dark', description: 'Dark silvery space aesthetic', isDark: true, category: 'Bootswatch' },
    { id: 'superhero', name: 'Superhero', description: 'The brave and the blue', isDark: true, category: 'Bootswatch' },
    { id: 'superhero-light', name: 'Superhero Light', description: 'Light mode with heroic orange', isDark: false, category: 'Bootswatch' },
    { id: 'united', name: 'United', description: 'Ubuntu orange and unique font', isDark: false, category: 'Bootswatch' },
    { id: 'united-dark', name: 'United Dark', description: 'Dark Ubuntu-inspired theme', isDark: true, category: 'Bootswatch' },
    { id: 'vapor', name: 'Vapor', description: 'Vaporwave aesthetic', isDark: true, category: 'Bootswatch' },
    { id: 'vapor-light', name: 'Vapor Light', description: 'Light vaporwave aesthetic', isDark: false, category: 'Bootswatch' },
    { id: 'yeti', name: 'Yeti', description: 'A friendly foundation', isDark: false, category: 'Bootswatch' },
    { id: 'yeti-dark', name: 'Yeti Dark', description: 'Dark friendly theme', isDark: true, category: 'Bootswatch' },
    { id: 'zephyr', name: 'Zephyr', description: 'Breezy and bright', isDark: false, category: 'Bootswatch' },
    { id: 'zephyr-dark', name: 'Zephyr Dark', description: 'Dark breezy theme', isDark: true, category: 'Bootswatch' },
    ...
    { id: 'evergreen', name: 'Node.js', description: 'Node.js green dark theme', isDark: true, category: 'Programming' },
    { id: 'gopher', name: 'Go', description: 'Go bright theme with cyan', isDark: false, category: 'Programming' },
    ...
    { id: 'kernel', name: 'C/C++', description: 'C/C++ classic dark theme', isDark: true, category: 'Programming' },
    { id: 'kotlin', name: 'Kotlin', description: 'Kotlin / JetBrains orange-to-purple theme', isDark: false, category: 'Programming' },
    { id: 'oxide', name: 'Rust', description: 'Rust dark theme with orange', isDark: true, category: 'Programming' },
